...
module.exports = {
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      //define the embed
      const endembed = new MessageEmbed().setColor("#8bc3e4")
        .setAuthor(`Music Queue ended.`, erroremoji)
      //set the embed
  ...
  let thumb;
    if (song.thumbnail === undefined) thumb = "https://cdn.discordapp.com/emojis/849244037788467241.png?v=1";
    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.id) {
        ...
        case "769915194444480542":
          ...
          const skipembed = new MessageEmbed().setColor("#8bc3e4").setAuthor(`${user.username} skipped the song.`, "https://cdn.discordapp.com/attachments/748633941912584333/753201474691137647/next.png")
        ...
        case "769912238236106793":
          ...
          if (queue.playing) {
            ...
            const pausemebed = new MessageEmbed().setColor("#8bc3e4")
            ...
            const playembed = new MessageEmbed().setColor("#8bc3e4")
        ...
        case "769913064194834511":
          ...
          const loopembed = new MessageEmbed().setColor("#8bc3e4")
            .setAuthor(`Loop is now ${queue.loop ? " \`Enabled\`" : " \`Disabled\`"}`, "https://cdn.discordapp.com/emojis/852172936118665236.gif?v=1")
        ...
        case "769915194066862080":
          ...
          if (!canModifyQueue(member)) return;
          queue.songs = [];
          const stopembed = new MessageEmbed().setColor("#8bc3e4").setAuthor(`${user.username} stopped the music!`, "https://cdn.discordapp.com/emojis/849243655666532362.png?v=1")
