  ...
  **34: ** [\`${Radiostations[34-1].split(" ")[0]}\`](${Radiostations[34-1].split(" ")[1]})`, inline: true },
    ...
    if(!message.guild)      
      ...
      if (args[0] == null) {
        ...
        message.author.send(new MessageEmbed().setColor("#8bc3e4")
  ...
  const song = {
    title: args2[0],
    url: args2[1],
    thumbnail: "https://cdn.discordapp.com/emojis/849244037788467241.png?v=1",
    duration: 10000,
  };
  let a, b;
  if(!serverQueue){
  ...
  message.channel.send(new MessageEmbed().setColor("#8bc3e4")
  .setDescription(`**✅ 🔍 \`${Radiostations[i-1].split(" ")[0]}\`**`));
  //mute yourself
